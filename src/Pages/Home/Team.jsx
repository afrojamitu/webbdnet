            ...
            <div className='md:w-7/12 md:mx-auto mx-5'>
                ...
                <div className='grid md:grid-cols-3 gap-10 py-10'>
                    <div className='bg-white text-black flex flex-col items-center py-12 px-3 rounded-lg shadow-xl relative'>
                        ...
                        <div className='border w-52 h-52 md:w-36 md:h-36 rounded-full flex items-center justify-center absolute top-[115px] md:top-[93px]'>
                            <img className='w-40 h-40 md:w-28 md:h-28 rounded-full' src={team1} />
                        </div>
                    ...
                    <div className='bg-white text-black flex flex-col items-center py-12 px-3 rounded-lg shadow-xl relative'>
                        ...
                        <div className='border w-52 h-52 md:w-36 md:h-36 rounded-full flex items-center justify-center absolute top-[115px] md:top-[93px]'>
                            <img className='w-40 h-40 md:w-28 md:h-28 rounded-full' src={team2} />
                        </div>
                    ...
                    <div className='bg-white text-black flex flex-col items-center py-12 px-3 rounded-lg shadow-xl relative'>
                        ...
                        <div className='border w-52 h-52 md:w-36 md:h-36 rounded-full flex items-center justify-center absolute top-[115px] md:top-[93px]'>
                            <img className='w-40 h-40 md:w-28 md:h-28 rounded-full' src={team3} />
                        </div>
